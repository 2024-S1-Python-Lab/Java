...
int empid, String compName, String qual, double
salary)
{
...
{String sub, dept;
int Tid;
Teacher(String name, String gender, String addr, int age, int
empid,
String compName, String qual, double salary, String
sub,
String dept, int Tid)
{
super(name, gender, addr, age, empid, compName, qual,
salary);
this.sub = sub;
this.dept = dept;
this.Tid = Tid;
